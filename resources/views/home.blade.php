...
@section('contents')
<div class="container" ng-controller="HomeController as hc">
  <table class="table table-hover" datatable="" dt-options="hc.dtOptions" dt-columns="hc.dtColumns" dt-instance="hc.dtInstance">
  </table>
</div>
@endsection
